module.exports = {
    en: {
        petsinplanes: {
            header: `Pets in planes`,
            text: `All dogs and cats traveling within the European Union must be
    ...
    ka: {
        ...
        petsinplanes: {
            header: `შინაური ცხოველები თვითმფრინავებში`,
            text: `ყველა ძაღლი და კატა, რომელიც მოგზაურობს ევროკავშირში, უნდა იყოს
