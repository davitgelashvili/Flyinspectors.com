module.exports = {
    en: {
        mechanical:{
            header:` Airports that you may never want to leave`,
            text:` International air travel is normally a pretty stressful affair. We
    ...
    ka: {
        mechanical:{
            header:`აეროპორტები, რომელთა დატოვება შეიძლება არასოდეს მოგინდეთ`,
            text:` საერთაშორისო საჰაერო მოგზაურობა ჩვეულებრივ საკმაოდ სტრესული საქმეა. ჩვენ
            იჩქარეთ მხოლოდ აეროპორტამდე მისასვლელად. შემდეგ ვდგავართ გრძელ რიგებში
