module.exports = {
    en: {
        KnowsYourRights: {
            ...
            info2:"Just as delays, flight cancellations happen too. If you were not notified 14 days prior you are eligible for compensation.",
            lable3:"Missed Connection",
            info3:"You can’t always get to desired destination with one flight, sometimes you have to use connecting flights. Which depends on the schedules of each other and can be missed even with the slightest delays.",
            lable4:"Damaged / Lost Luggage",
    ...
    ka: {
        KnowsYourRights: {
            ...
            info2:"ისევე როგორც დაგვიანებები, არც ფრენის გადადებაა იშვიათი. ასეთ შემთხვევაში თუ თქვენ არ მიგიღიათ წინასწარი გაფრთხილება მინიმუმ 14 დღით ადრე, თქვენ გეკუთვნით ფრენის კომპენსაცია.",
            lable3:"დამაკავშირებელი ფრენა",
            info3:"ყოველთვის არ არის შესაძლებელი დანიშნულების ადგილამდე ერთი რეისით ჩასვლა, ზოგჯერ გვჭირდება დამაკავშირებელი რეისები. ეს კი დამოკიდებულია ამ რეისების განრიგზე და პუნქტუალობაზე და შესაძლებელია მცირე დაგვიანებამაც რეისის გამოტოვება გამოიწვიოს. ამ შემთხვევაში შესაძლოა გეკუთვნოდეთ ფრენის კომპენსაცია.",
            lable4:"დაზიანებული/დაკარგული ბარგი",
